...
export default function AegisRealtimeVoice({token}){
 ...
 askAegis(normalized)});connection.on(RealtimeEvents.ERROR,()=>{stopListening();setState('idle');toast.error('Realtime transcription had a problem. Please try again.')})}catch(e){setState('idle');toast.error(e.message||'Could not start realtime voice')}};
