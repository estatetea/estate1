    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6">
        <div className="w-full max-w-lg text-center fade-up">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-light text-white mb-3" data-testid="failure-heading">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <button
              ...
              className="w-full border border-white/20 hover:border-[#D4AF37] text-white font-light uppercase tracking-[0.2em] py-4 rounded-lg transition-colors text-sm sm:text-base touch-manipulation flex items-center justify-center gap-2"
            >
          ...
          <p className="text-xs text-gray-600 mt-8 leading-relaxed max-w-xs mx-auto">
            If the issue persists, please reach out to us and we'll be happy to help.
          </p>
        </div>
      </main>
    </div>
