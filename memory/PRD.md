...
- [x] Cinematic video landing page (Logo fade → "Get Started" on dark bg → Click starts video → Near video end, tea grains fall & video fades → Grains fade as entry form appears)
