...
- [x] Cinematic video landing page (Logo smooth fade → Video first frame bg + "Get Started" → Click plays video fully → Video fades to black → 3-layer grain stream continues from dead center matching video's pour: 70 core + 45 scatter + 20 dust → Falls into black abyss → 12 wisps dissolve → Login form slowly emerges from darkness)
